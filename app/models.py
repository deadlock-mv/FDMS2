...
class Itemlist(models.Model):
    id = models.AutoField(primary_key=True)
    category = models.ForeignKey(Categorylist, blank=True, null=True, related_name="items", on_delete=models.CASCADE)
...
class Orderitem(models.Model):
    ...
    itemid = models.ForeignKey(Itemlist, models.DO_NOTHING)
